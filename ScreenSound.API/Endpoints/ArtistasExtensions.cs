    ...
    public static void AddEndPointsArtistas(this WebApplication app)
    {
            ...
            ) =>
        {
            ...
            var email = context.User.Claims
                ...
                .Value ?? throw new InvalidOperationException("Pessoa não está conectada");
            ...
            ) =>
        {
            ...
            var email = context.User.Claims
                .FirstOrDefault(c => c.Type == ClaimTypes.Email)?
                .Value ?? throw new InvalidOperationException("Não foi encontrado o email da pessoa logada");
